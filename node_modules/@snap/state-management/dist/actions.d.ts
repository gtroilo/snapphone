...
declare type ActionCreators<Actions extends readonly Action[]> = {
    readonly [K in keyof Actions]: ActionCreator<Actions[K]>;
};
export declare type ActionCreatorMap<T extends readonly Action[]> = {
...
export declare type ActionCreator<A extends Action> = IfEmpty<A['data'], {
    (): A;
    name: A['name'];
}, {
    (data: A['data']): A;
