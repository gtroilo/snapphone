...
export declare type Actions<M extends StateMachine<any, any>> = M extends StateMachine<infer Actions, any> ? Actions : never;
export declare type States<M extends StateMachine<any, any>> = M extends StateMachine<any, infer States> ? States : never;
/**
