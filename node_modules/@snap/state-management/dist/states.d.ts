...
export declare type StateCreatorMap<T extends readonly State[]> = {
    [Name in T[number]['name']]: StateCreator<Named<T[number], Name>>;
};
export declare type StateCreators<States extends readonly State[]> = {
...
export declare type StateCreator<S extends State> = IfEmpty<S['data'], {
    (): S;
    name: S['name'];
}, {
    (data: S['data']): S;
