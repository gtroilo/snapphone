...
export declare class LensAssetRepository {
    ...
    constructor(lensCore: LensCoreModule, assetLoaders: Map<AssetType, [keyof LensCoreModule["AssetType"], AssetLoader]>, metrics: MetricsEventTarget, requestStateEventTarget: RequestStateEventTarget);
    /**
...
export declare const lensAssetRepositoryFactory: {
    (args_0: LensCoreModule, args_1: AssetLoader, args_2: AssetLoader, args_3: AssetLoader, args_4: MetricsEventTarget, args_5: RequestStateEventTarget): LensAssetRepository;
